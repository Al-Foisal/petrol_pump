                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Model </th><td> {{ $vehicle->model }} </td></tr><tr><th> Vehicle Number </th><td> {{ $vehicle->vehicle_number }} </td></tr><tr><th> Supervisor Name </th><td> {{ $vehicle->supervisor_name }} </td></tr>
                                </tbody>
                            </table>
                        </div>
